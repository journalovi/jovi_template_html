...
`);
  ...
  const T$5 = Template('d-footnote', `<style>
...
`);
  ...
  function endorsementsTemplate(frontMatter) {
    return `
...
`;
  ...
  class JoviEndorsements extends HTMLElement {
